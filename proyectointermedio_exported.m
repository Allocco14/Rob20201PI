classdef proyectointermedio_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        DireccinIPEditFieldLabel     matlab.ui.control.Label
        DireccinIPEditField          matlab.ui.control.EditField
    ...
    methods (Access = private)
                ...
                if(app.AUTOMTICOButton.Value == 1)
                    if(app.unoButton.Value == 1)
                        ...
                        for a=1:20
                            ...
                            fk = app.Phantom.fkine(msg2.Position(1:4));
        ...
        function TutorialButtonValueChanged(app, event)
            value = app.TutorialButton.Value;
            if(value == 1)
                app.PanelTutorial.Visible = 'on';
            end
            if(value == 0)
                app.PanelTutorial.Visible = 'off';
            end
        end
        ...
        function DirectaCheckBoxValueChanged(app, event)
            ...
            if(value == 1)
                ...
                app.DireccinIPEditField.Enable = 'off';
                app.DireccinIPEditField.Value = '';
                app.DireccinIPEditFieldLabel.Enable = 'off';
        ...
        function MquinaVirtualVMCheckBoxValueChanged(app, event)
            ...
            if(value == 1)
                ...
                app.DireccinIPEditField.Enable = 'on';
                app.DireccinIPEditFieldLabel.Enable = 'on';
            end
            if(value == 0)
                app.CONECTARButton.Enable = 'off';
                app.EstadoROSLabel.Text = 'Desconectado';
        ...
        function CONECTARButtonValueChanged(app, event)
            ...
            if(value == 1)
                ...
                if(app.MquinaVirtualVMCheckBox.Value == 1)
                    rosinit(app.DireccinIPEditField.Value);
                end
                pause(1);
        ...
        % Value changed function: DireccinIPEditField
        function DireccinIPEditFieldValueChanged(app, event)
            app.CONECTARButton.Enable = 'on';
            app.EstadoROSLabel.Text = 'Listo para conectar';
        end
    end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.CONECTARButton.Position = [217 172 100 27];
            ...
            app.DESCONECTARButton.Enable = 'off';
            app.DESCONECTARButton.Position = [408 172 124 27];
            app.DESCONECTARButton.Text = 'DESCONECTAR';

            % Create DireccinIPEditFieldLabel
            app.DireccinIPEditFieldLabel = uilabel(app.ConexionPanel);
            app.DireccinIPEditFieldLabel.HorizontalAlignment = 'right';
            app.DireccinIPEditFieldLabel.FontName = 'Prototype';
            app.DireccinIPEditFieldLabel.FontSize = 14;
            app.DireccinIPEditFieldLabel.Enable = 'off';
            app.DireccinIPEditFieldLabel.Position = [197 254 78 22];
            app.DireccinIPEditFieldLabel.Text = 'Dirección IP';

            % Create DireccinIPEditField
            app.DireccinIPEditField = uieditfield(app.ConexionPanel, 'text');
            app.DireccinIPEditField.ValueChangedFcn = createCallbackFcn(app, @DireccinIPEditFieldValueChanged, true);
            app.DireccinIPEditField.FontName = 'Prototype';
            app.DireccinIPEditField.FontSize = 14;
            app.DireccinIPEditField.Enable = 'off';
            app.DireccinIPEditField.Position = [290 254 100 22];
            ...
            app.EstadoROSLabel.Position = [259 128 215 22];
            app.EstadoROSLabel.Text = 'Desconectado';
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = proyectointermedio_exported
